			...
			$fields = array(
				...
				*/
				...
				'ai_generate_key_desc'    => array(
					'section' => 'ai_generator',
					'type'    => 'custom',
					'label'   => sprintf( __( 'You can get your API Key in your %1$sOpenAI Acount%2$s. We use the text-davinci-003 model.  You must install %3$sMeta Box%4$s plugin.', 'wolmart' ), '<a href="https://platform.openai.com/account/api-keys" target="_blank">', '</a>', '<b>', '</b>' ),
				),
					...
					array(
						...
						'product_type'                    => array(
							...
							'choices' => array(
								...
								'product-9' => WOLMART_ASSETS . '/images/options/products/product-sm-9.jpg',
							),
						),
						'show_in_box'                     => array(
							'section' => 'product_type',
